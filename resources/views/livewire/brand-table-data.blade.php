                        ...
                        <div class="p-4 lg:p-5">
                            <div class="py-4">
                                <input type="file" wire:model='image'
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 w-full dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
                            <div class="grid grid-cols-2 gap-4 mb-4 ">
                                ...
                                <div class="col-span-2">
                                    <label for="order_index"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Order Index</label>
                                    <input wire:key="{{ rand() }}" type="number" name="order_index"
                                        id="order_index" wire:model='newOrderIndex'
                                        class="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        @else
                            <th scope="row"
                                ...
                                <a href="{{ asset('assets/images/brands/' . $item->image) }}" class="glightbox">
                                    <img src="{{ asset('assets/images/brands/' . $item->image) }}"
