<div>
    ...
    <div
        ...
        <div
            ...
            @can('create setting')
            <x-primary-button href="{{ url('admin/product_categories/create') }}">
                ...
                <tr wire:key='{{ $item->id }}'
                    ...
                    <th scope="row"
                        ...
                        <a href="{{ asset('assets/images/categories/' . $item->image) }}" class="glightbox">
                            <img src="{{ asset('assets/images/categories/' . $item->image) }}"
                                alt="Image" class="object-contain h-10 mr-3 aspect-[1/1]">
                        </a>
                    </th>
                    <td class="px-6 py-4">
                        <a href="{{ asset('assets/images/categories/' . $item->banner) }}" class="glightbox">
                            <img src="{{ asset('assets/images/categories/' . $item->banner) }}"
                                alt="Image" class="object-contain h-10 mr-3 aspect-[1/1]">
                        </a>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-start justify-center gap-3">
                            ...
                            <div class="pb-1" x-data="{ tooltip: false }">
                                <!-- Modal toggle -->
                                <a href="{{ url('admin/product_categories/'.$item->id.'/edit') }}" @mouseenter="tooltip = true" @mouseleave="tooltip = false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
