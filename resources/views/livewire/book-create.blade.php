                ...
                <div class="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                    <div class="md:col-span-2">
                        ...
                        <x-text-input wire:model='title' id="title" class="block w-full mt-1" type="text"
                            name="title" placeholder="Product Title" :value="old('title')" autocomplete="title" />
                        <x-input-error :messages="$errors->get('title')" class="mt-2" />
                    </div>
                    <div class="md:col-span-2">
                        <x-input-label for="short_description" :value="__('Key Specifications')" />
                        <textarea wire:model='short_description' class="w-full p-2 mt-1 border rounded bg-gray-50"
                            placeholder="Key Specifications">{{ $short_description }}</textarea>
