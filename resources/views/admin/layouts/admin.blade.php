        ...
        <aside
            ...
            <div class="h-full px-3 py-5 overflow-y-auto bg-white dark:bg-gray-800 pb-[8rem]">
                ...
                <ul>
                    ...
                    <li x-data="{
                            open: {{ request()->is('admin/product_categories*') || request()->is('admin/brands*') || request()->is('admin/books*') || request()->is('admin/sub_categories*') ? 'true' : 'false' }},
                            init() {
                                if ({{ request()->is('admin/product_categories*') || request()->is('admin/brands*') || request()->is('admin/books*') || request()->is('admin/sub_categories*') ? 'true' : 'false' }}) {
                        ...
                        <ul x-show="open" x-transition class="py-2 ml-2 space-y-2">
                            ...
                            <li>
                                <a href="{{ url('admin/product_categories') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('admin/product_categories*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                                    Categories
                                </a>
                            </li>
                            <li>
                ...
                <ul class="pt-5 pb-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <li>
                        <a href="{{ url('admin/settings/support') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('admin/settings/support*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                            Support
                        </a>
                    </li>
